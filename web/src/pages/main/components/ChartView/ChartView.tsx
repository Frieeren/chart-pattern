import type { TimeframeOption, SymbolOption } from '@web/shared/types/domain';
import {
  chartViewSection,
  timeframeInfo,
  symbolInfo,
  ...
  return (
    <div className={chartViewSection}>
      <div className={timeframeInfo}>
        현재 시간 프레임: {formatTimeframe(timeframe)}
      </div>
